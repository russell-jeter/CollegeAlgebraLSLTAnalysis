...
def show_exam_question_distractor_counts(dict_of_dfs=None):
    ...
    if total_count > 0:
        exam_question_distractor_count_frame["percent"] = exam_question_distractor_count_frame["count"] / total_count
    else:
...
def show_student_distractor_selection_counts(dict_of_dfs=None):
    ...
    if total_count > 0:
        student_responses_distractor_selection_counts["percent"] = student_responses_distractor_selection_counts["count"] / total_count
    else:
